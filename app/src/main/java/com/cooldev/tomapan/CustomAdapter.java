...
class CustomAdapter extends ArrayAdapter<String> {
        ...
        //{
            ...
            holder.Buton.setOnClickListener(new View.OnClickListener() {
                public void onClick(final View v) {
                    ...
                    if(playeri < maximi)
                    {
                        if (holder.Buton.getText().toString().equals("Intra"))
                        {
                            if(!intrat)
                            {
                                if(holder.privata.getVisibility() == View.VISIBLE)
                                {
                                    ...
                                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which)
                                        {
                                            ...
                                            String urmatoarele[] = new String[7];
                                            urmatoarele[0] = "5";
                                            urmatoarele[1] = "room";
                                            urmatoarele[2] = holder.room_id;
                                            urmatoarele[3] = "name";
                                            urmatoarele[4] = Rooms.name;
                                            urmatoarele[5] = "parola";
                                            urmatoarele[6] = input.getText().toString();
                                ...
                                Toast.makeText(contextRooms, "Esti deja intrat intr-o camera!", Toast.LENGTH_LONG).show();
    ...
    public void CheckStart()
    {
        ...
        new ATask(ceva).execute(primele, urmatoarele);
    }
    ...
    {
        Intent incercare = new Intent(contextRooms, Game.class);
    ...
    public class ATask extends AsyncTask<String[], Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(success)
            {
                ...
                {
                    if (actiune.equals("CheckPlayers"))
                    {
                        myHolder.players.setText(rezultat);
                    ...
                    else if (actiune.equals("CheckStart") && intrat)
                    {
                        if (!rezultat.equals("N"))
                        {
                            myHolder.Buton.setText("Intra");
                            openGame(rezultat);
                        }
                    }
